...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body id="top">
        <header>
            <div class="profile-page sidebar-collapse">
              <nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
                <div class="container">
                  <div class="navbar-translate"><a class="navbar-brand" href="#" rel="tooltip">>Demo Web Profile_</a>
      ...
      <div class="profile-page">
        <div class="wrapper">
          <div class="page-header page-header-small" filter-color="green">
            <div class="page-header-image" data-parallax="true" style="background-image: url({{ asset('resume-imt/images/cc-bg-1.jpg') }})"></div>
            <div class="container">
              <div class="content-center">
                <div class="cc-profile-image"><a href="#"><img src="{{ asset('resume-imt/images/anthony.jpg') }}" alt="Image"/></a></div>
                <div class="h2 title">Mr. Gelayy</div>
                <p class="category text-white" id="typing-data"></p>
                <a class="btn btn-primary smooth-scroll mr-2" href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Rekrut Saya</a><a class="btn btn-primary" href="#" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Download CV</a>
              </div>
            </div>
            <div class="section">
              <div class="container">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-12">
                <div class="card-body">
                  ...
                  <p>Halo! Perkenalkan saya adalah Gelayy aka Pussy :)</p>
                  <p>
              ...
              <div class="col-lg-6 col-md-12">
                <div class="card-body">
                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col-sm-8">pussy@imt.com</div>
                  </div>
                  <div class="row mt-3">
                    <div class="col-sm-4"><strong class="text-uppercase">Whatsapp</strong></div>
                    <div class="col-sm-8">+6289668756161</div>
                  </div>
                  <div class="row mt-3">
                    <div class="col-sm-4"><strong class="text-uppercase">Alamat</strong></div>
                    <div class="col-sm-8">Perum Grha Mandiri 2 Blok U No.15, Jl. Lempake Jaya RT.02</div>
                  </div>
                  <div class="row mt-3">
                    <div class="col-sm-4"><strong class="text-uppercase">Bahasa</strong></div>
                    <div class="col-sm-8">Indonesia, Russia, Jawa</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="section" id="skill">
        <div class="container">
          <div class="h4 text-center mb-4 title">Kemampuan Saya</div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                        <figure class="cc-effect"><img src="{{ asset('resume-imt/images/project-1.jpg') }}" alt="Image"/>
                          <figcaption>
                    ...
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                        <figure class="cc-effect"><img src="{{ asset('resume-imt/images/project-2.jpg') }}" alt="Image"/>
                          <figcaption>
                  ...
                  <div class="col-md-6">
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                        <figure class="cc-effect"><img src="{{ asset('resume-imt/images/project-3.jpg') }}" alt="Image"/>
                          <figcaption>
                    ...
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                        <figure class="cc-effect"><img src="{{ asset('resume-imt/images/project-4.jpg') }}" alt="Image"/>
                          <figcaption>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                        <figure class="cc-effect"><img src="{{ asset('resume-imt/images/graphic-design-1.jpg') }}" alt="Image"/>
                          <figcaption>
                    ...
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                        <figure class="cc-effect"><img src="{{ asset('resume-imt/images/graphic-design-2.jpg') }}" alt="Image"/>
                          <figcaption>
                  ...
                  <div class="col-md-6">
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                        <figure class="cc-effect"><img src="{{ asset('resume-imt/images/graphic-design-3.jpg') }}" alt="Image"/>
                          <figcaption>
                    ...
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                        <figure class="cc-effect"><img src="{{ asset('resume-imt/images/graphic-design-4.jpg') }}" alt="Image"/>
                          <figcaption>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#Photography">
                        <figure class="cc-effect"><img src="{{ asset('resume-imt/images/photography-1.jpg') }}" alt="Image"/>
                          <figcaption>
                    ...
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#Photography">
                        <figure class="cc-effect"><img src="{{ asset('resume-imt/images/photography-3.jpg') }}" alt="Image"/>
                          <figcaption>
                  ...
                  <div class="col-md-6">
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#Photography">
                        <figure class="cc-effect"><img src="{{ asset('resume-imt/images/photography-2.jpg') }}" alt="Image"/>
                          <figcaption>
                    ...
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#Photography">
                        <figure class="cc-effect"><img src="{{ asset('resume-imt/images/photography-4.jpg') }}" alt="Image"/>
                          <figcaption>
      ...
      <div class="section" id="contact">
        <div class="cc-contact-information" style="background-image: url({{ asset('resume-imt/images/staticmap.png') }}); background-size: cover; background-repeat: no-repeat;">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="card-body">
                          <form action="https://formspree.io/your@email.com" method="POST">
                            <div class="p pb-3"><strong>Jika ingin berdiskusi ringan, mari tinggalkan pesan :) </strong></div>
                            <div class="row mb-3">
                              <div class="col">
                      ...
                      <div class="col-md-6">
                        <div class="card-body">
                          ...
                          <p class="pb-2">Perum Grha Mandiri 2 Blok U No.15, Jl. Lempake Jaya RT.02</p>
                          <p class="mb-0"><strong>Whatsapp</strong></p>
                          <p class="pb-2">+6289668756161</p>
          ...
          <footer class="footer">
            ...
            <div class="h4 title text-center">Mr. Gelayy</div>
            <div class="text-center text-muted">
              <p>&copy; Bootcamp IMT. All rights reserved.<br>Design - <a class="credit" href="https://templateflip.com" target="_blank">TemplateFlip</a></p>
            </div>
          </footer>
        ...
        <script>
          var typed = new Typed('#typing-data', {
            strings: ['Front End Developer', 'Graphic Designer', 'IoT Enginner'],
            typeSpeed: 30,
            startDelay: 40,
            backDelay: 900,
            backSpeed: 30,
